                  ...
                  <div className="commentBar">
                    ...
                    <form onSubmit={e => e.preventDefault()}>
                      <input
                        ...
                        type="text"
                      />
                      <button disabled className="commentButton1" type="submit">
                        <h1 className="posting1">게시</h1>
                      </button>
                    </form>
                  </div>
                </div>
              </div>
              <div className="secondFeeds">
                <div className="feedsHearder">
                  <div className="feedsGradation">
                    <img
                      alt="피드2 이미지"
                ...
                <div className="feeds1Photo">
                  <img
                    alt="사진1 이미지"
                    className="photo1"
                    src="/images/yunsumin/dog_pohto_2.jpg"
                  />
                </div>
                <div className="commentBox">
                  <div className="lickBar">
                    <div>
                      <button type="button" className="hartButton1">
                        <svg
                          className="hart1"
                          xmlns="http://www.w3.org/2000/svg"
                          viewBox="0 0 512 512"
                  ...
                  <div className="lickView">
                    <div className="viewImgDiv">
                      <img alt="강이지5" src="/images/yunsumin/dog5.jpg" />
                    </div>
                    <p>flex_12님 외</p>
                    <b className="lieckr1">9134명</b>
                    <p>이 좋아합니다</p>
                  </div>
                  <div className="title">
                    wecode_S_
                    <span>친구집 댕댕이 왜이렇게 자는지 아는사람?</span>
                  </div>
                  <div className="comments">
                    <a href="#!">댓글 921개 모두 보기</a>
                  </div>
                  ...
                  <div className="commentBar">
                    ...
                    <form onSubmit={e => e.preventDefault()}>
                      <input
                        ...
                        type="text"
                      />
                      <button disabled className="commentButton2" type="submit">
                        <h1 className="posting2">게시</h1>{' '}
                      </button>
                    </form>
                  </div>
                </div>
